...
function App() {
  return <div className="shell">
    ...
    <main>
      ...
      <section className="platforms" aria-labelledby="platform-title"><div className="section-heading"><h2 id="platform-title">Suas plataformas <span>01</span></h2><span>Acesso rápido</span></div>
